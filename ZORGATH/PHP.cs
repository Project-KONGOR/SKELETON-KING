...
public class PHP
{
    ...
    private class ObjectSerializer : ISerializer
    {
        ...
        {
            /*
            // First, see how many non-null values we want to serialize.
    ...
    public readonly struct Property
    {
        ...
        public Property(PropertyInfo? propertyInfo, FieldInfo? fieldInfo, string name, string? customName, bool isInteger, long key/*, ISerializer serializer */)
        {
